...
include_once("../timezones.php");
	...
	and (securelogin()==true) ) {
		if(isset($_POST['sublikeaction'])){
			$subcomid=(int)$_POST['sublikeaction'];
			...
			while($row = mysqli_fetch_array($result)){
				...
				if(in_array($_COOKIE['id'], $likes)) {
					...
					VALUES ('".$puserid."','".$_COOKIE['id']."','".$postid."','".$comid."','".$subcomid."','".$notid."',".((int) true).",".((int) false).",".((int) false).",".((int) false).",".((int) false).",".((int) false).")";
