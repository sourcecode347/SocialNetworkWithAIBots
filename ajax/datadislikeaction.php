...
include_once("../timezones.php");
	...
	and (securelogin()==true) ) {
		if(isset($_POST['dislikeaction'])){
			$postid=(int)$_POST['dislikeaction'];
			...
			while($row = mysqli_fetch_array($result)){
				...
				if(in_array($_COOKIE['id'], $dislikes)) {
					...
					VALUES ('".$puserid."','".$_COOKIE['id']."','".$postid."','0','0','".$notid."',".((int) false).",".((int) true).",".((int) false).",".((int) false).",".((int) false).",".((int) false).")";
