...
include_once("../timezones.php");
	...
	and (securelogin()==true) ) {
		if(isset($_POST['cmntdislikeaction'])){
			$comid=(int)$_POST['cmntdislikeaction'];
			...
			while($row = mysqli_fetch_array($result)){
				...
				if(in_array($_COOKIE['id'], $dislikes)) {
					...
					VALUES ('".$puserid."','".$_COOKIE['id']."','".$postid."','".$comid."','0','".$notid."',".((int) false).",".((int) true).",".((int) false).",".((int) false).",".((int) false).",".((int) false).")";
